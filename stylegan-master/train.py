...
if 1:
    ...
    # Dataset.
    #commentata riga seguente e aggiunta successiva
    #desc += '-ffhq';     dataset = EasyDict(tfrecord_dir='ffhq');                 train.mirror_augment = True
    desc += '-ffhq';     dataset = EasyDict(tfrecord_dir='custom_cats');                 train.mirror_augment = True
